...
public class TheTeleOP extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()) {
            ...
            if (robot.arm != null) {
                if (gamepad1.a) {  //2.left_stick_y > 0.2
                    robot.arm.setTargetPosition(-90);
                    robot.armSetPower(armpow);
                }
                if (gamepad1.y) {  //2.left_stick_y < -0.2
                ...
                if (gamepad1.b) {   //Math.abs(gamepad2.left_stick_x) > 0.2
            ...
            robot.duckPower(gamepad1.left_trigger);
            ...
            if(gamepad1.left_bumper && robot.sensorDistance.getDistance(DistanceUnit.CM) > 6) { //intake
                robot.wheel1.setPosition(0.9);
                robot.wheel2.setPosition(0.1);
            }
