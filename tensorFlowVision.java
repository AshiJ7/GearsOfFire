...
public class tensorFlowVision extends LinearOpMode {
    ...
    private static final String VUFORIA_KEY =
            " AeB2SIT/////AAABmWZYUwGyh0+9huUEJxqPa6J+xFOcI7j+9c31P3Ur75VxNWhs4NnmuICHs+t5X/Z9CjXPa6" +
                    "jDkQefZuVLo02//QR0v/rkM+d1PxvpLpSfV4PcBm+unWA298h9CC+xjqhG8I0PMPaRzvTTkyYBjRUmdC+VF" +
                    "kAPvDm9f3wBLyOeY6MQg+HihlX6jfJ7YkjBnHD/DoUCWEveAI5V3pyubI9yzYHV8iWPykuIoWhXjnFQ8iwm" +
                    "1AuTMrwDIrUVPYzUhJ+unm4LqE5xQpfqiodt/Y7qDTm+QPz51bPPGzFke77T6EsAcz+Lb5YbBggQwRlOpsg" +
                    "wM4OV/va74FGRIEgPcT+0xgURJ7u91SmD74rESpiGQiQw";
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            //if statements converting value to barcode position and level
                            if (duckPosition < 400)
                            {
                                level = "1";
                            }
