...
public class Blue2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(level.equals("ONE")) {
            ...
            turn(120);
            moveencoder.Drive(0.7, -32, 32, 32, -32);
            wait(500);
            moveencoder.Drive(0.35, -27, -27, -27, -27);
        ...
        if(level.equals("TWO")) {
            ...
            turn(130);
            moveencoder.Drive(0.7, -34, 34, 34, -34);
            wait(500);
            moveencoder.Drive(0.35, -27, -27, -27, -27);
            if(robot.arm.getCurrentPosition() != 32) {
                robot.arm.setTargetPosition(32);
