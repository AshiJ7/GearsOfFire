...
@Autonomous(name = "camera red side 2")
...
public class Red2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (level.equals("ONE")) { //bottom tier
            moveencoder.Drive(0.4, 2.2, 2.2, 2.2, 2.2);  //5 for level 3 and 2
            robot.setsClawPosition(0.165);

            wait(1000);
            //moveencoder.Drive(0.6, -24.5, 24.5, 24.5, -24.5);
            strafeLeft(16, 0.4);
            ...
            wait(3000);
            moveencoder.Drive(0.4, 5, 5, 5, 5); //not there for level 3, 2 for level 2
            robot.setsClawPosition(0.165);
            ...
            turn(270);
            moveencoder.Drive(0.2, -4.5, 4.5, 4.5, -4.5);
            driveForward(50, 0.7);
        ...
        if (level.equals("TWO")) { //middle tier
            ...
            robot.arm.setTargetPosition(-972);  //-800 for level 3, -950 for level 2
            robot.arm.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            robot.armSetPower(0.18);
            wait(4000);
            moveencoder.Drive(0.4, 2.5, 2.5, 2.5, 2.5); //not there for level 3, 2 for level 2
            robot.setsClawPosition(0.165);
            while (robot.arm.isBusy() && robot.digitalTouch.getState() == true) {
                telemetry.addData("TargetPosition ", robot.arm.getTargetPosition());
                telemetry.addData("CurrentPosition ", robot.arm.getCurrentPosition());
        ...
        if (level.equals("THREE")) {  //top tier
            ...
            sleep(2000);
            robot.intakeSetPower(0.15);
            robot.arm.setTargetPosition(-829);  //-800 for level 3, -950 for level 2
            robot.arm.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            robot.armSetPower(0.2);
            wait(3000);
            robot.setsClawPosition(0.165);
            ...
            telemetry.update();
            moveencoder.Drive(0.3, -5, -5, -5, -5);
            turn(270);
            moveencoder.Drive(0.2, -5.2, 5.2, 5.2, -5.2);
            driveForward(50, 0.7);
            robot.intakeSetPower(0.6);
        }
    }
