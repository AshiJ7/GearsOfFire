...
@Autonomous(name = "camera blue side 1")
...
public class Blue1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (level.equals("ONE")) { //bottom tier
            ...
            robot.arm.setTargetPosition(-1067);  //-800 for level 3, -950 for level 2
            ...
            telemetry.update();
            moveencoder.Drive(0.3, -3.5, -3.5, -3.5, -3.5);
            turn(90);
        ...
        if (level.equals("THREE")) {  //top tier
            ...
            sleep(2000);
            robot.intakeSetPower(0.15);
            robot.arm.setTargetPosition(-838);  //-800 for level 3, -950 for level 2
            robot.arm.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            robot.armSetPower(0.2);
            wait(3000);
            robot.setsClawPosition(0.165);
