...
@Autonomous(name = "camera red side 1 with duck")

public class Red1Duck extends LinearOpMode {
    //red side 1
    ...
    public void runOpMode() {
        ...
        while (!opModeIsActive())
            ...
            wait(500);
            movegyro.Drive(0.4, -5, -50, robot, telemetry);
            ...
            turn(-40);
            sleep(500);
            moveencoder.Drive(0.4, 11.5, 11.5, 11.5, 11.5);
            strafeLeft(8, 0.4);
            robot.duckPower(0.4);
            sleep(2500);
            moveencoder.Drive(0.7, -10, -10, -10, -10);
            turn(180);
            sleep(500);
            moveencoder.Drive(0.5, -6, 6, 6, -6);
            driveForward(40, 0.45);
            moveencoder.Drive(0.4, -3, 3, 3, -3);
            driveForward(22, 0.5);
            telemetry.update();
    }
